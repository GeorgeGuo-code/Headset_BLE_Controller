...
#define GESTURE_DEFAULT_COOLDOWN_MS         1500     /*!< min ms between any two fired events — 1500ms covers the ~1220ms return-swing window after a nod plus margin, preventing false TILT from return motion */
